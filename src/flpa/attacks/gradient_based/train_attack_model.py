...
# Paths
FEATURES_PATH = "outputs/attacks/gradient_based/gradient_attack_features.parquet"
MODEL_DIR = Path("outputs/attacks/gradient_based/models")
METRICS_DIR = Path("outputs/attacks/gradient_based/metrics")

# Config
TEST_SIZE = 0.2
RANDOM_STATE = 42
FEATURE_COLUMNS = ["grad_norm"]  # ✅ Only one feature for this attack
...
def train_all_attack_models():
    ...
    assert "grad_norm" in df.columns, "Expected 'grad_norm' column missing in dataset"
