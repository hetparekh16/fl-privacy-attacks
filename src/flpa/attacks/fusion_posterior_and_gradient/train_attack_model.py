...
FEATURES_PATH = "outputs/attacks/fusion/fused_attack_features.parquet"
FEATURE_COLUMNS = [f"posterior_{i}" for i in range(10)] + ["grad_norm"]
MODEL_DIR = Path("outputs/attacks/fusion/models")
METRICS_DIR = Path("outputs/attacks/fusion/metrics")
